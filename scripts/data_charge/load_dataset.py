...
def load_dataset(dataset_name: str, val_split_size: float = 0.2):
    """
    ...
    if dataset_name == 'cifar10':
        ...
        y_train, y_val, y_test = [to_categorical(d, num_classes=len(np.unique(d))) for d in (y_train, y_val, y_test)]
    ...
    # Common Preprocessing: Normalize images to the [0, 1] range and convert to float32
